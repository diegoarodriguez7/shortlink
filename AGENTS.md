...
- **[Auuthentication Guidelines](docs/clerk-auth.md)** - Clerk integration, route protection, and auth patterns.
- **[UI Components](docs/shadcn-ui.md)** - shadcn/ui usage and component conventions.
...
Detailed, topic-specific standards live in [docs/](docs/).

> [!IMPORTANT]
> Before generating ANY code, you MUST read every relevant individual instructions file in [docs/](docs/) (e.g. [docs/clerk-auth.md](docs/clerk-auth.md), [docs/shadcn-ui.md](docs/shadcn-ui.md), [docs/nextjs-conventions.md](docs/nextjs-conventions.md)). This is non-negotiable — do not skip it, do not rely on memory of a previous read, and do not assume general Next.js/Clerk/shadcn knowledge is sufficient, since this project deviates from defaults.
